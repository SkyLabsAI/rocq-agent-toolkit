...
def _record_context_success_metrics(extractor: AttributeExtractor, operation_name: str, duration: float):
...
def _record_context_error_metrics(extractor: AttributeExtractor, operation_name: str, 
