...
class BusinessOperationExtractor(CustomExtractor):
    ...
    def __init__(self, 
        ...
        if include_user_id:
            if user_id_extractor:
                ...
                attribute_extractors["business.user_id"] = self._default_user_id_extractor
        
        if include_tenant_id:
            if tenant_id_extractor:
                attribute_extractors["business.tenant_id"] = tenant_id_extractor
            else:
                attribute_extractors["business.tenant_id"] = self._default_tenant_id_extractor
    ...
    def _default_user_id_extractor(self, func: Callable, args: Tuple, kwargs: Dict[str, Any]) -> Optional[str]:
    ...
    def _default_tenant_id_extractor(self, func: Callable, args: Tuple, kwargs: Dict[str, Any]) -> Optional[str]:
...
class MLOperationExtractor(CustomExtractor):
    ...
    def _extract_input_shape(self, func: Callable, args: Tuple, kwargs: Dict[str, Any]) -> Optional[str]:
    ...
    def _extract_batch_size(self, func: Callable, args: Tuple, kwargs: Dict[str, Any]) -> Optional[int]:
