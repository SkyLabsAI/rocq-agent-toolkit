...
class WorkflowExtractor(AttributeExtractor):
    ...
    def get_metrics_labels(self, func: Callable, args: Tuple, kwargs: Dict[str, Any]) -> Dict[str, str]:
        ...
        if state:
            ...
            if workflow_id:
                ...
                labels["workflow_prefix"] = workflow_id[:8] if len(workflow_id) > 8 else workflow_id
    ...
    def _find_state(self, args: Tuple, kwargs: Dict[str, Any]):
        ...
        if args:
            ...
            if hasattr(first_arg, '__dict__') and hasattr(first_arg, '__class__') and len(args) > 1:
                return args[1]
            else:
                return first_arg
