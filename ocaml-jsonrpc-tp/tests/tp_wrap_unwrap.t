  ...
  {
    "id": 1,
    "params": [ 0, "Inductive n := Zero : n | Succ : n -> n." ],
    "method": "run",
    "jsonrpc": "2.0"
  }
  {
    "id": 2,
    "params": [ 0, "Require Import Stdlib.ZArith.BinInt." ],
    "method": "run",
    "jsonrpc": "2.0"
  }
  {
    "id": 3,
    "params": [ 0, "Require Import Stdlib.ZArith.BinIntt" ],
    "method": "run",
    "jsonrpc": "2.0"
  }
  {
    "id": 4,
    "params": [ 0, "Require Import Stdlib.ZArith.BinInk." ],
    "method": "run",
    "jsonrpc": "2.0"
  }
  {
    "id": 5,
    "params": [ 0, "Lemma test : 0 = 0." ],
    "method": "run",
    "jsonrpc": "2.0"
  }
