...
This demonstrates how to use Provenance.Reflect.Data to mark class and instance
...
class MyAgent(
    ...
    # Using Data directly (it returns Annotated internally)
    cfg: Final[Provenance.Reflect.Data[Config]] = Config()

    # Class variable with explicit transform
    threshold: Final[Provenance.Reflect.Data[float, lambda x: round(x, 2)]] = 0.95123
    ...
    normalized: Final[Provenance.Reflect.Data[float, normalize]] = 0.95123
    ...
    def __init__(self, model_name: str) -> None:
        ...
        super().__init__()
        # Instance field with explicit transform (callable validated and auto-wrapped in TransformData)
