...
* **Phase 1 (Current):** The server will run locally, reading `jsonl` result files generated by agents directly from the local filesystem.
...
# Rocq Agent Toolkit Backend - Setup Guide

## Overview
This is a FastAPI backend server that serves agent task results for visualization in a frontend application.
