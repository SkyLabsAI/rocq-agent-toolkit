  ...
  return (
    <div className='min-h-screen bg-elevation-surface-sunken text-text flex flex-col'>
      ...
      <div className='justify-center border-b border-elevation-surface-overlay bg-elevation-surface'>
        <div className='flex items-center justify-between gap-4 backdrop-blur-sm  px-10 py-4'>
          <div className='flex items-center'>
            <Link to={'/'}>
            <div className='flex items-center' >
              <LogoIcon />
              <h1 className="ml-2.5 text-text font-['Noto_Sans'] text-base font-normal leading-[normal]">
                Skylabs AI
              </h1>
            </div>
            </Link>
