...
Ltac2 json_of_string : string -> json := fun s =>
  String s.

Ltac2 json_of_floag : float -> json := fun f =>
  Float f.
...
Ltac2 json_of_array : ('a -> json) -> 'a array -> json := fun f a =>
  json_of_list f (Array.to_list a).
